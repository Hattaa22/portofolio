...
$profile = [
    'name' => 'Suhatta',
    'role' => 'Junior Full Stack Engineer · Laravel & Flutter Specialist',
    'eyebrow' => 'Sarjana Terapan Sistem Informasi Bisnis · Politeknik Negeri Malang',
    'tagline' => 'Lulusan D4 Sistem Informasi Bisnis Polinema (IPK 3.51) yang berfokus pada REST API Laravel, aplikasi mobile Flutter, dan antarmuka web responsif.',
    'bio' => 'Fresh graduate D4 Sistem Informasi Bisnis dengan pengalaman magang di software house dan 10+ project web/mobile. Terlibat dalam analisis kebutuhan, pengembangan fitur, perancangan database, integrasi API, testing, hingga deployment.',
    'location' => 'Indonesia',
...
'stats' => [
    ...
    'skills' => [
        ...
        ['name' => 'React & TypeScript', 'icon' => 'component', 'cat' => 'Frontend', 'desc' => 'Digunakan pada Invoice App untuk membangun komponen UI modular dan type-safe.'],
...
'projects' => [
        [
            ...
            'desc' => 'Sistem web untuk mengumpulkan, mengelola, dan menganalisis survei kepuasan dari berbagai pemangku kepentingan Polinema.',
            'contribution' => 'Merancang database MySQL, mengembangkan fungsi backend dan API, mengelola data survei, serta mengoptimalkan sistem.',
        ...
        [
            ...
            'desc' => 'Sistem web dan mobile untuk pendataan serta rekomendasi kegiatan sertifikasi dan pelatihan bagi dosen Jurusan Teknologi Informasi Polinema.',
            'contribution' => 'Mengembangkan aplikasi Laravel dan Flutter, merancang database MySQL, mengintegrasikan API web-mobile, serta melakukan optimasi aplikasi.',
        ...
        [
            ...
            'type' => 'Web & Mobile Application',
            'role' => 'Full Stack Developer',
            'desc' => 'Aplikasi web, mobile, dan PWA untuk operasional depo air minum: cabang, transaksi, stok, laporan, dan monitoring performa.',
            'contribution' => 'Mengembangkan Flutter client dan backend Laravel REST API /api/v1 menggunakan Dio, GetX, MySQL, local storage, autentikasi, serta fitur QR scanning.',
            'stack' => ['Flutter', 'Dart', 'Laravel', 'REST API', 'Dio', 'GetX', 'MySQL'],
            'icon' => 'glass-water',
            'accent' => 'cyan',
            'images' => [
